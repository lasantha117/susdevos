  ...
  return (
    <div className="items-center justify-center p-24 h-screen w-screen text-center mx-auto place-content-center">
      ...
      <div className="flex gap-2 justify-center">
        <button className="font-medium border-2 bg-white p-2 rounded-lg text-slate-950 hover:bg-slate-100 w-[163px] h-[60px]">
          Go Back
        </button>
        <button className="font-medium border-2 bg-slate-950 text-white p-2 rounded-lg hover:bg-slate-800 w-[163px] h-[60px]">
          Take me home
        </button>
      </div>
    </div>
