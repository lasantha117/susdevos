...
export default function TextBanner() {
  return (
    <div className="bg-teal-500 min-h-64 lg:h-[305px] w-full">
      <div className="flex flex-col py-14 lg:py-10 mx-auto">
        {/* Heading */}
        ...
        {/* content */}
        <p className="mt-1 lg:h-[108px] lg:w-[729px] font-medium text-lg lg:text-2xl leading-6 lg:leading-9 text-center text-slate-900 mx-10 lg:mx-auto">
