      ...
      <div className="max-w-7xl px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="-mr-2 flex xl:hidden">
            ...
            <Button onPress={toggleMenu} className="inline-flex items-center justify-center p-2 rounded-md text-teal-400 hover:text-white hover:bg-teal-700 focus:outline-none focus:bg-teal-700 focus:text-white">
